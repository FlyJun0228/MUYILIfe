...
public class NewAdapter  extends BaseAdapter {
    ...
    public NewAdapter(Third third, List<javabean> list, ListView listView) {
        mList = list;
        layoutInflater = LayoutInflater.from(third.getContext());
      //context要使用当前adapter的界面对象layoutinflater（布局装载器对象）
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       /*   if (convertView == null){
        ...
        return convertView;*/
        //比较好的适配方法
        NewAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            viewHolder = new NewAdapter.ViewHolder();
            convertView = layoutInflater.inflate(R.layout.itemmuyi, null);
            viewHolder.imageView = (ImageView) convertView.findViewById(R.id.showw);
            viewHolder.name = (TextView) convertView.findViewById(R.id.shownew);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (NewAdapter.ViewHolder) convertView.getTag();
        }
